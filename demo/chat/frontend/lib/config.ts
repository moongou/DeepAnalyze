...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    CONFIG_DATA_DICTIONARY_IMPORT: "/v1/config/data-dictionary/import",
...
export const API_URLS = {
  ...
  CONFIG_DATA_DICTIONARY_IMPORT: buildApiUrl(API_CONFIG.ENDPOINTS.CONFIG_DATA_DICTIONARY_IMPORT),
